...
// ÔöÇÔöÇÔöÇ Preview Style Enum ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
enum PreviewStyle { plain, notebook, grid, leaf, spiral, dark }

// ÔöÇÔöÇÔöÇ Preview Style Painter ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
class PreviewStylePainter extends CustomPainter {
  ...
  // Line spacing matches body text: 14px font ├ù height:2.0 = 28px per line
...
EdgeInsets styleContentPadding(PreviewStyle style) {
  switch (style) {
    case PreviewStyle.notebook:
      // Margin line at x=64, leave 10px gutter ÔåÆ left = 76
      return const EdgeInsets.fromLTRB(76, 10, 16, 16);
    case PreviewStyle.spiral:
      // Binding ~56px wide, margin at x=72, leave 10px gutter ÔåÆ left = 84
