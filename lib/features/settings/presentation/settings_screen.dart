...
class SettingsScreen extends ConsumerWidget {
        ...
        body: Column(
          children: [
            ...
            Expanded(
              child: TabBarView(
                children: [
                  _buildProfileTab(context, settings, userRole, ref),
                  _buildAppearanceTab(context, settings, ref),
                  _buildEditorTabWithSync(context, settings, userRole, ref),
                ],
              ),
            ),
          ],
  ...
  Widget _buildProfileTab(BuildContext context, AppSettingsModel settings, UserRole userRole, WidgetRef ref) {
    return ListView(
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
      children: [
        SubscriptionPanel(activeRole: userRole),
        const SizedBox(height: 16),
        _buildWorkspaceModePicker(context, settings, ref),
        const SizedBox(height: 24),
      ],
    );
  }

  Widget _buildAppearanceTab(BuildContext context, AppSettingsModel settings, WidgetRef ref) {
    final theme = Theme.of(context);
  ...
  Widget _buildEditorTabWithSync(BuildContext context, AppSettingsModel settings, UserRole userRole, WidgetRef ref) {
    return ListView(
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
      children: [
  ...
  Widget _buildWorkspaceModePicker(BuildContext context, AppSettingsModel settings, WidgetRef ref) {
    final theme = Theme.of(context);
    final activeCustom = settings.activeCustomProfile;
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(
                  activeCustom != null ? Icons.settings_suggest_outlined : settings.userMode.icon,
                  color: theme.colorScheme.primary,
                  size: 24
                ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Active Workspace: ${activeCustom != null ? activeCustom.name : settings.userMode.displayName}',
                      ...
                      Text(
                        activeCustom != null
                            ? '${activeCustom.isAdvanced ? "Advanced" : "Simple"} custom profile configuration.'
                            : settings.userMode.description,
                        style: theme.textTheme.bodySmall?.copyWith(
                          color: theme.colorScheme.onSurface.withOpacity(0.6),
                        ),
                      ),
            ...
            Wrap(
              ...
              children: [
                ...AppUserMode.values.where((m) => m != AppUserMode.custom).map((mode) {
                  ...
                  return ChoiceChip(
                    avatar: Icon(mode.icon, size: 16, color: isSelected ? theme.colorScheme.onPrimary : theme.colorScheme.primary),
              ...
              Wrap(
                ...
                children: settings.customProfiles.map((profile) {
                  ...
                  return InputChip(
                    ...
                    deleteIconColor: isSelected ? theme.colorScheme.onPrimary.withOpacity(0.8) : theme.colorScheme.onSurface.withOpacity(0.5),
                    onSelected: (selected) {
                      if (selected) {
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                Icon(
                                  Icons.spa_rounded, 
                                  color: !_isAdvanced ? theme.colorScheme.primary : theme.colorScheme.onSurface.withOpacity(0.4),
                                  size: 22,
                                ),
