          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                previewBar(const Color(0xFFCC99FF).withOpacity(0.7), 0.8),
                const SizedBox(height: 4),
                previewBar(const Color(0xFFCC99FF).withOpacity(0.7), 0.65),
                const SizedBox(height: 4),
                previewBar(const Color(0xFFCC99FF).withOpacity(0.7), 0.72),
              ],
            ),
          ),
        ],
